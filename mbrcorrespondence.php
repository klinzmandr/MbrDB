...
<!-- <div class="col-sm-3">Source: <input placeholder="Source" type="text" name="SourceofInquiry" value="$source"</div> -->
</div>  <!-- row -->
<div class="row">
...
if ($_REQUEST['action'] == "apply") {
	...
	$vararray['Reminders'] = '';
	// corresondence type is a renewal reminder										
	if ($vararray['CorrespondenceType'] == 'RenewalReminder') {
		$vararray['Reminders'] = 'RenewalReminder';	}
