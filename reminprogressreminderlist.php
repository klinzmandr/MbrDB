...
echo '<h3>Outstanding Reminders&nbsp;&nbsp;<a href="javascript:self.close();" class="btn btn-primary">CLOSE</a></h3>';
echo "<h4>Listing of $drcount MCID's:</h4>
	<p>The MCID&apos;s listed are those that have been sent reminders.  The listing provides the sorted total count of reminders that have been sent as well as the date of the last one. An MCID will be removed from this list when one of the following occurs:</p>
	<ol>
	<li>A funding payment is received and entered as a &apos;Dues&apos; payment,</li>
	<li>The member record is marked as &apos;Inactive&apos;,</li>
	<li>The status of the member record is marked as &apos;0-Contacts&apos;, or</li>
	<li>The status of the member record is marked as &apos;3-Donor&apos;.</li>
</ol>";
echo "<table border=\"0\" class=\"table table-condensed\">";
echo "<tr><th>MCID</th><th align=\"center\">Name</th><th align=\"center\">Count</th><th>Last Sent</th><th align=\"center\">Type Sent</th></tr>";
...
<td>$mcid</td><td>$name</td><td>$count</td><td>$ls</td><td>$ct</tr>
