...
<p>This page is to provide all available scripts developed for use by the phone soliciation person to be used during the course of a conversation with the active MCID.  Use the &apos;MCID Lookup&apos; function of the main menu to estalish an &apos;active&apos; MCID.  Contact infomation about the &apos;active&apos; MCID is available on the Info tab of the main menu.  Funding and Correspondence tabs provide historical funding support and member contact information.</p>
...
<p>This page opens up as a seperate tab or window.  All scripts are a part of the page downloaded so that navigation between them is very fast.  Click the appropriate tab to begin.</p>
...
<ul>
<li><p>On-line membership payment or donation on our web site or through PayPal</p></li>
<li><p>Setting up an automatic payment with your bank (would you like more iformation?)</p>
<li><p>Sending a check or money order directly (would you like the address or have me send a self addressed return remittence envelope?)</p>
</ul>
</div>  <!-- tab-pane -->
