...
print <<<formPart1
<script>
var parent.chgFlag = 0;
function chkchg() {
	if (parent.chgFlag <= 0) { return true; }
	var r=confirm("All changes made (" + chgFlag + ") will be LOST.\\n\\nConfirm by clicking OK.");	
	if (r == true) { parent.chgFlag = 0; return true; }
		return false;
	}
</script>
<script>
...
<form action="mbrdonationsiframe.php" method="get"  name="mcform" id="mcform" class="form-inline" onsubmit="return validateForm(this)">
<div class="row">
<div class="col-sm-3">
...
<h4>Funding Log for $mcid</a>&nbsp;&nbsp;<a  class="btn btn-xs btn-primary" href="mbrdonationsiframe.php?action=add" onclick="return anchorconfirm()">(Add new record)</a></h4>
<table class="table">
...
while ($row = $results->fetch_assoc()) {
	...
	$frm = "<tr>";
	if ($purpose == "Dues") {
		$frm .= "<td><a onclick=\"return confirmDel()\" href=\"mbrdonationsiframe.php?action=delete&id=$donid&date=$dondate\"><img src=\"config/b_edit.png\" width=\"16\" height=\"16\" alt=\"DELETE\" longdesc=\"DELETE\" /></a></td>"; 
		}
	else {
  $frm .= "<td><a onclick=\"return chkchg()\" href=\"mbrdonationsiframe.php?action=edit&id=$donid\">
