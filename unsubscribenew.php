...
if ($action == '') {
	$ema = urlencode($em);
print <<<pageOut
<a href="http://www.pacificwildlifecare.org"><img border="0" src="images/logo_bg.jpg"></a>
...
<p>You may cancel this action and return to the <a href="$HomeURL">HOME</a> web page.</p>
...
echo "<a href=\"$HomeURL\">
<img border=\"0\" src=\"images/logo_bg.jpg\"></a>
<h2>PWC Unsubscribe Confirmation</h2>";
echo "<p>Email address to be removed: $em</p>";
echo "<p>Thank you for your past support.</p>
<p>Your request has been forwarded for processing.  You may now close this window or click the following link to return to the <a href=\"$HomeURL\">HOME PAGE</a> of the web site.</p>
</body>
</html>";
?>
