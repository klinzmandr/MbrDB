...
<ul id="myTab" class="nav nav-tabs">
  ...
  <li class=""><a href="#donations" data-toggle="tab" onclick="return chkchg()">Funding</a></li>
  <!-- <li class=""><a href="mbrdonations.php" onclick="return chkchg()">Funding</a></li> -->
  <li class=""><a href="#correspondence" data-toggle="tab" onclick="return chkchg()">Correspondence</a></li>
...
print <<<pagePart2
	...
	<li class=""><a href="#followup" data-toggle="tab" onclick="return chkchg()">Follow Up</a></li>
...
<iframe frameborder="0" height="450" width="1000" sandbox="allow-forms allow-scripts" src="mbrdonationsiframe.php">
</iframe>
</div>  <!-- tab-pane -->

<!-- Tab 3 correspondence tab -->
<div class="tab-pane fade" id="correspondence">
<iframe frameborder="0" height="450" width="1000" sandbox="allow-forms allow-scripts" src="mbrcorrespondenceiframe.php">
</iframe>
</div>  <!-- tab-pane -->
...
bkLib.onDomLoaded(function() {
	new nicEditor({buttonList : ['left', 'center', 'right', 'bold','italic','underline','indent', 'outdent', 'ul', 'ol', 'hr', 'forecolor', 'bgcolor','link','unlink']}).panelInstance('areaX');
	});
</script>
...
<iframe frameborder="0" height="460" width="1000" sandbox="allow-same-origin allow-forms allow-scripts" src="mbrfollowupiframe.php">
</iframe>
</div>  <!-- tab-pane -->
