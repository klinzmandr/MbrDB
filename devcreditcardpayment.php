...
<p>This page displays the interface provided to allow entry of information to allow and payment or donation from a member over the phone via an autorized credit card payment system.  This is in the instance when they are willing to provide that information over the phone.  Successful entry of the transaction will provide a response receipt that can then be sent to the member&apos;s email address (if one is on the membership record.)</p>
<h4>CAUTION</h4>
<ul>
...
?>
<div class="container">
<h4>Display of credit card interface and data entry page</h4>
